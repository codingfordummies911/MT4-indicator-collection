...
double valUp[],valDn[],val[],volUpa[],volDna[],volUpb[],volDnb[],znUp[],znDn[],volSm[],vol[],bup[],bdn[];
//+------------------------------------------------------------------+
...
//--- indicator buffers mapping
   ...
   SetIndexBuffer(9, bup   ,INDICATOR_DATA);
   SetIndexBuffer(10,bdn   ,INDICATOR_DATA);
   SetIndexBuffer(11,volSm ,INDICATOR_CALCULATIONS);
   SetIndexBuffer(12,vol   ,INDICATOR_CALCULATIONS);
//---
...
//---
   for(int i=limit; i>=0 && !_StopFlag; i--)
   {
      ...
      bup[i] = val[i] + atr*AtrMultiplier;
      bdn[i] = val[i] - atr*AtrMultiplier;
   }   
   for(int i=limit; i>=0 && !_StopFlag; i--)
     {
