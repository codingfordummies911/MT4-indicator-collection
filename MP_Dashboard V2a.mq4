...
int labelcolor;
   ...
   for(int i=0;i<ArraySize(TradePair);i++)  
       ...
       ObjectDelete("TotProf");
         ...
         if (Signalm1[i]==1&&Signalm5[i]==1&&Signalm15[i]==1&&Signalm30[i]==1&&Signalh1[i]==1&&Signalh4[i]==1&&Signald1[i]==1&&Signalw1[i]==1&&Signalmn[i]==1&&Signalhah4[i]==1&&Signalhad1[i]==1)
            labelcolor = clrGreen;
         else if (Signalm1[i]==-1&&Signalm5[i]==-1&&Signalm15[i]==-1&&Signalm30[i]==-1&&Signalh1[i]==-1&&Signalh4[i]==-1&&Signald1[i]==-1&&Signalw1[i]==-1&&Signalmn[i]==-1&&Signalhah4[i]==-1&&Signalhad1[i]==-1)
               labelcolor = clrRed;
             else
        ...
        // SetPanel("Bar1",0,x_axis+978,y_axis-5,121,80,Maroon,Maroon,1);
         ...
         SetText("MA","H4      D1",x_axis+462,y_axis-17,White,8);
...
void closeOpenOrders(string currency,int orderType )
{
   ...
   for(int i=0;i<orders;i++) {
      if(OrderSelect(i, SELECT_BY_POS)==true) {
         ...
         if(OrderType() == orderType && OrderSymbol() == currency && orderType == OP_BUY ==Magic_Number) {
